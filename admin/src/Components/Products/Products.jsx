    ...
    return (
        <div className="products">
            ...
            <div className="products-add-title field-row">
                <p>Title</p>
                <input value={productDetails.title} onChange={changeHandler} type="text" name="title" placeholder="Required" />
            </div>
            <div className="products-add-price field-row">
                <div className="products-add-price-group">
                    <p>Price</p>
                    <input value={productDetails.price} onChange={changeHandler} type="text" name="price" placeholder="Required" />
                </div>
                <div className="products-add-price-group">
                    <p>Old Price</p>
                    <input value={productDetails.price_old} onChange={changeHandler} type="text" name="price_old" placeholder="Optional" />
                </div>
            </div>
            ...
            <div className="products-add-description">
                <p>Description</p>
                <textarea value={productDetails.description} onChange={changeHandler} name="description" placeholder="Required"></textarea>
            </div>
            ...
            <button onClick={AddProduct} className="products-add-button">Add Product</button>
        </div>
    );
};
